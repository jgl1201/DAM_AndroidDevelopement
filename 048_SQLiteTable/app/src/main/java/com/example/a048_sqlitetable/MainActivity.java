package com.example.a048_sqlitetable;
...
/* a; hacer click corto sobre un elemento de la lista,
cambiamos la funcionalidad:
en vez de un toast, lo ponemos en los editText
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                mEditTextDefinition.setText(mDB.getDefinition(id));
            }
        });
