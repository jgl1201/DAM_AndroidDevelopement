package com.example.a050_lawyers.lawyerdetail;
...
import com.example.a050_lawyers.R;
import com.example.a050_lawyers.addeditlawyer.AddEditLawyerActivity;
import com.example.a050_lawyers.data.Lawyer;
import com.example.a050_lawyers.data.LawyersDbHelper;
import com.example.a050_lawyers.lawyers.LawyersActivity;
import com.example.a050_lawyers.lawyers.LawyersFragment;
...
public class LawyerDetailFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.action_edit) showEditScreen();
        if (item.getItemId() == R.id.action_delete) new DeleteLawyerTask().execute();
