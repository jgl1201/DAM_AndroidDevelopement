package com.example.a057_providerddbb.provider;

import static com.example.a057_providerddbb.provider.BaseDatos.*;
import static com.example.a057_providerddbb.provider.Contrato.*;
...
public class ProviderApartamentos extends ContentProvider {
    ...
    static {
        ...
        uriMatcher.addURI(AUTORIDAD, "alquileres", ALQUILERES);
        uriMatcher.addURI(AUTORIDAD, "alquileres/*", ALQUILERES_ID);
    }
